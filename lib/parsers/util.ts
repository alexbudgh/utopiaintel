...
export const GAME_DATE_RE =
  /^(January|February|March|April|May|June|July) \d+ of YR\d+$/;

/** Accuracy pattern used by most spy ops */
export const ACCURACY_RE =
  /we have\s*([\d,]+)%\s*confidence in the information retrieved/;
