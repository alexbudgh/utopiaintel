...
const TYPE_TO_CATEGORY = new Map<string, Category>(
  (Object.entries(CATEGORY_TYPES) as [Category, string[]][]).flatMap(
    ([cat, types]) => types.map((t) => [t, cat]),
  ),
);
...
function formatDetail(row: ProvinceNewsRow): string | null {
  ...
  switch (eventType) {
    ...
    case "attack_trad_march":
      return amount != null ? `${n(amount)} acres taken` : null;
    case "attack_conquest":
      return amount != null ? `${n(amount)} acres (turned away)` : null;
    case "attack_razed":
      return amount != null ? `${n(amount)} bldgs razed` : null;
    case "attack_ambush":
      return amount != null ? `${n(amount)} acres recaptured` : null;
    case "attack_massacre":
      return "troops massacred";
    case "attack_learn":
      return amount != null ? `${n(amount)} books learned` : null;
    case "attack_plunder":
      return amount != null
        ? `${n(amount)} ${resLabel(resourceType)} plundered`
        : null;
    case "attack_failed":
      return "attack repelled";
    // Thievery
    case "resource_stolen":
      return amount != null
        ? `${n(amount)} ${resLabel(resourceType)} stolen`
        : null;
    case "troops_killed":
      return amount != null ? `${n(amount)} troops killed` : null;
    case "peasants_kidnapped":
      return amount != null ? `${n(amount)} kidnapped` : null;
    case "desertions":
      return amount != null ? `${n(amount)} men deserted` : null;
    case "arson":
      return amount != null ? `${n(amount)} bldgs burned` : null;
    case "thief_propaganda":
      return amount != null ? `${n(amount)} abandoned` : null;
    case "thief_sabotage_wizards":
      return amount != null ? `${n(amount)} ticks affected` : null;
    // Sorcery — damage
    case "spell_fireball":
      return amount != null ? `${n(amount)} peasants killed` : null;
    case "spell_lightning":
      return amount != null ? `${n(amount)} runes destroyed` : null;
    case "spell_meteor":
      return amount != null
        ? `${n(amount)} ${resLabel(resourceType)} killed`
        : null;
    case "spell_land_lust":
      return amount != null ? `${n(amount)} acres vanished` : null;
    case "spell_tornado":
      return amount != null ? `${n(amount)} bldgs razed` : null;
    case "spell_fools_gold":
      return amount != null ? `${n(amount)} gc → lead` : null;
    case "spell_vermin":
      return amount != null ? `${n(amount)} bushels devoured` : null;
    case "spell_animate_dead":
      return amount != null ? `${n(amount)} peasants lost` : null;
    // Sorcery — duration
    ...
    case "spell_nightmares":
      return amount != null ? `${n(amount)} ticks` : null;
    // Dragon
    case "dragon_damage":
      return amount != null ? `${n(amount)} soldiers killed` : null;
    // Aid
    case "aid_received":
      return amount != null
        ? `${n(amount)} ${resLabel(resourceType)} received`
        : null;
    // Misc
    case "exploration":
      return amount != null ? `${n(amount)} acres settled` : null;
    case "war_ended":
      return amount != null ? `${n(amount)} acres returned` : null;
    case "monthly_dedication":
      return amount != null ? `${n(amount)} gc` : null;
    case "utopian_lords_reward":
      return amount != null ? `${n(amount)} ${resLabel(resourceType)}` : null;
    default:
      return null;
  }
}
...
function attackVerb(eventType: string): string | null {
  switch (eventType) {
    ...
    case "attack_massacre":
      return "massacred us";
    case "attack_learn":
      return "learned from us";
    case "attack_plunder":
      return "plundered us";
    case "attack_ambush":
      return "ambushed our army";
    case "attack_failed":
      return "failed to attack us";
    case "arson":
      return "set fire to us";
    default:
      return null;
  }
}
...
export function ProvinceNewsTable({
  events,
  loc,
  prov,
  from,
  ...
  if (events.length === 0) {
    return (
      <div className="text-sm text-gray-500">
        No province news recorded. Browse the province news page in Utopia to
        submit intel.
      </div>
    );
  }
  ...
  return (
    <>
      <UtopiaDateRangeFilter
        basePath={`/kingdom/${encodeURIComponent(loc)}/${encodeURIComponent(prov)}`}
        from={from}
        to={to}
      ...
      <div className="space-y-0.5">
        {visible.map((row) => {
          ...
          return (
            <div
              key={row.id}
              className="flex items-start gap-3 rounded px-3 py-1.5 text-sm hover:bg-gray-800/30"
            >
