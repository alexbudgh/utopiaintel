...
const COLUMNS = [
  ...
  { key: "elites",      label: "Elites",      group: "Military",  desc: "Total elites (SoT)"                          },
  { key: "war_horses",  label: "Horses",      group: "Military",  desc: "Total war horses (SoT)"                      },
  { key: "soldiers_home",  label: "SolHome",  group: "Military",  desc: "Soldiers at home (SoM)"                      },
  { key: "off_specs_home", label: "OSpec Home", group: "Military", desc: "Off specs at home (SoM)"                    },
  { key: "def_specs_home", label: "DSpec Home", group: "Military", desc: "Def specs at home (SoM)"                    },
  { key: "elites_home",    label: "EliHome",  group: "Military",  desc: "Elites at home (SoM)"                        },
  ...
  { key: "stealth",     label: "Stealth",     group: "T/M",       desc: "Stealth % (self only — from throne)"         },
  { key: "wizards",     label: "Wizards",     group: "T/M",       desc: "Wizards"                                     },
  { key: "mana",        label: "Mana",        group: "T/M",       desc: "Mana % (self only — from throne)"            },
