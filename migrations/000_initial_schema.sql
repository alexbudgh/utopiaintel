-- Initial schema. Subsequent migrations (001–…) layer additive changes on top.
...
-- province_status.kingdom is added by migration 004
...
-- rob_ops columns added by migrations: 001 (deserters, deserter_type),
-- 002 (game_date, game_date_ord), 006 (wizards_assassinated, prisoners_freed,
-- prisoners_captured), 007 (arson_building, target_game_id, thieves_sent), 008 (source)
...
-- sorcery_ops columns added by migrations: 002 (game_date, game_date_ord),
-- 007 (target_game_id), 008 (source)
...
-- attack_ops columns added by migrations: 002 (game_date, game_date_ord), 008 (source)
...
-- intel_ops columns added by migrations: 002 (game_date, game_date_ord)
